...
private:
    ...
    std::vector<bool> thread_busy; // data structure to check if the thread is executing a task
    std::vector<bool> running_threads;
    ...
    int num_tasks = 0; 
    void runThreadwPool(int i); // thread functionaility
public:
